...
namespace ControlTreeView
{
    public partial class CTreeView
    {
        ...
        public void OnBeforeNodeChanged(object _sender, CTreeViewEventArgs e)
        {
            BeforeNodeChanged(_sender, e);
        }
        public void OnAfterNodeChanged(object _sender, CTreeViewEventArgs e)
        {
            AfterNodeChanged(_sender, e);
        }
