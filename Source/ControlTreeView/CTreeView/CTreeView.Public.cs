...
namespace ControlTreeView
{
    public partial class CTreeView : Panel, INodeContainer
    {
            ...
            : base()
        {
            ...
            SelectionMode = CTreeViewSelectionMode.Single;
            ...
            Bitmap imagePlus = new Bitmap(Assembly.GetExecutingAssembly().GetManifestResourceStream("ControlTreeView.Resources.plus.png"));
            Bitmap imageMinus = new Bitmap(Assembly.GetExecutingAssembly().GetManifestResourceStream("ControlTreeView.Resources.minus.png"));
        ...
        public bool AutoExpandSelected { get; set; } = true;
		...
		public CTreeNode GetNodeByPath(List<int> IndexPath)
		{
            CTreeNode _ret = null;            
			if (this.Nodes != null && this.Nodes.Count > 0)
			{
                CTreeNodeCollection nodes = this.Nodes;
                ...
                foreach (int index in IndexPath)
                {
                    ...
                    {
                        throw new IndexOutOfRangeException("The path is not valid for the given TreeView.");
                    }
                }
            }            
            return _ret;
        ...
        public event EventHandler<CTreeViewEventArgs> BeforeNodeChanged = delegate { };
        public event EventHandler<CTreeViewEventArgs> AfterNodeChanged = delegate { };

        public void ClickEvent(EventArgs e)
		{
            this.OnClick(e);
		}
